...
# masses<-masses[!names(masses) %in% Apodiformes]
# adjusted for taxonomic subsets on 18/08/2022
...
# write.csv( x=size.scale.integration, file='size_scale_integration_noApods_18_08_2022.csv')
# write.csv( x=size.scale.integration.p, file='size_scale_integration_p_noApods_18_08_2022.csv')
